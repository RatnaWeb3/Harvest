...
const PrivyLoginSection = dynamic(() => import('./PrivyLoginSection'), {
  ssr: false,
  loading: () => (
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Choose a wallet to connect to Movement Network</DialogDescription>
        </DialogHeader>
        <div className="space-y-4">
            ...
            <>
              ...
              <div className="relative my-6">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="bg-card px-3 text-xs font-bold text-muted-foreground uppercase">
                    Or
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-3">
            <div className="text-center">
              <h3 className="text-lg font-bold mb-1">Connect Native Wallet</h3>
              <p className="text-xs text-muted-foreground">Use your existing Aptos wallet</p>
            </div>
            <div className="space-y-2">
              {filteredWallets?.length === 0 ? (
                <div className="text-center py-6 px-4 border-2 border-dashed border-border rounded-lg">
