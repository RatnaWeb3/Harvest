    ...
    <div className="space-y-3">
      ...
      {authenticated && user && (
        <div className="space-y-2">
          <div className="text-sm text-muted-foreground text-center bg-muted/50 p-3 rounded-lg border-2 border-border">
            <div className="flex items-center justify-center gap-2">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span>
                Authenticated as: {(user as any).email?.address || (user as any).phone?.number || 'User'}
              </span>
            </div>
          </div>

          {movementWallet ? (
            <div className="text-sm text-center bg-primary/10 border-2 border-primary/30 p-3 rounded-lg">
              <div className="flex items-center justify-center gap-2 mb-1">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="font-bold text-foreground">Movement Wallet Connected</span>
              </div>
            ...
            <div className="text-sm text-center bg-warning/10 border-2 border-warning/30 p-3 rounded-lg">
              <div className="flex items-center justify-center gap-2">
                <div className="w-2 h-2 bg-warning rounded-full"></div>
                <span className="text-muted-foreground">Click above to create wallet</span>
              </div>
            </div>
          )}
        </div>
